...
struct cvosoc_device_id {
    __u32 vendor, name;           /* Vendor and device ID or PCI_ANY_ID*/
    __u32 group, subgroup;     /* Subsystem ID's or PCI_ANY_ID */
...
static inline void cvsoc_set_drvdata(struct pci_dev *pdev, void *data)
{
