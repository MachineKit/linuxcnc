...
#include "config.h"
#if defined(USERMODE_SOCFPGA) && defined(BUILD_SYS_USER_DSO)
 ...
 **   /sys/bus/                                                         **
 **---------------------------------------------------------------------*/
#define UIO_SOCFPGA_PATH	"/proc/device-tree/sopc@0/bridge@0xc0000000/hm2-socfpga@0x100040000"

//Fixme//  Nasty global variable...only one board for now.
struct cvsoc_dev *one_dev = NULL;
