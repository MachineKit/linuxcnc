...
int rtapi_app_main(void)
{
    ...
    rtapi_print_msg(RTAPI_MSG_ERR, "Init stepgen\n");
    ...
    rtapi_print_msg(RTAPI_MSG_ERR, "Init encoder\n");
...
rtapi_print_msg(RTAPI_MSG_ERR, "prussdrv_init\n");
    // Allocate and initialize memory
    prussdrv_init ();

    // opens an event out and initializes memory mapping
rtapi_print_msg(RTAPI_MSG_ERR, "prussdrv_open\n");
